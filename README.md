...
## 💡 **Инфинитив и Императив — правила формулировки коммитов**

🗣 **Формулировка текста коммита имеет значение.** Хорошая практика — использовать подходящий стиль в зависимости от языка описания.

---

### 🇷🇺 **На русском — использовать инфинитив** (глагол в начальной форме)

Такой стиль читается как **план действий** или **список задач**.  
Подходит для большинства русскоязычных проектов и internal-документации.

✅ Примеры:

- Добавить поддержку шейдеров в сцене боя
    
- Исправить ошибку расчёта коллизий
    
- Переписать логику генерации карт
    
- Обновить зависимости Unity
    
- Настроить GitHub Actions для автосборки
    

📌 Используй инфинитив даже в описании коммита, чтобы сохранять единообразие:

```
Changes:
- Добавить фильтр по тегам в редакторе.
- Исправить падение при выходе за границы мира.
```

---

### 🇬🇧 **На английском — использовать императив** (глагол в повелительном наклонении)

Такой стиль выглядит как **инструкция к действию**, что исторически сложилось в англоязычных open-source проектах.
...
- Optimize player animation blend tree
    
- Configure CI to build development branch
    
- Refactor InventoryManager structure
    

📌 Императив должен быть использован **только в заголовке**, описание — в обычном прошедшем времени:

```
Changes:
- Implemented object pooling for enemies.
- Refactored camera follow logic.
```

---

### ⚠️ **Не смешивай стили внутри одного проекта**

> 🔧 Определи, какой стиль использовать по умолчанию (русский / английский).  
> Если команда интернациональная — лучше придерживаться английского.

---

### ✍️ **Практический совет по формулировке**

|Задача|На русском|На английском|
|---|---|---|
|Добавление функциональности|Добавить ...|Add ...|
|Исправление ошибки|Исправить ...|Fix ...|
|Обновление чего-то|Обновить ...|Update ...|
|Рефакторинг кода|Переписать ... / Улучшить...|Refactor ...|
|Настройка CI/CD или зависимостей|Настроить ...|Configure ... / Setup ...|
|Оптимизация|Оптимизировать ...|Optimize ...|
|Добавление тестов|Добавить тесты ...|Add tests for ...|
